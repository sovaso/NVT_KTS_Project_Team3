...
INSERT INTO location_zone (id, capacity, number_col, matrix, name, number_row, location_id) VALUES (2, 200, 20, 1, 'Name2', 10, 2) ON DUPLICATE KEY UPDATE id = 2;
...
INSERT INTO leased_zone (id, seat_price, maintenance_id,version, location_zone_id) VALUES (4, 200, 3, 0,2) ON DUPLICATE KEY UPDATE id = 4;
